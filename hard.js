const HARD_INCIDENTS = [
    {
        ...
        actions: [
            ...
            { l: 'Prepare evidence-based risk report and escalate to release authority', s: 'ISO-based action', c: true, p: 220, f: 'Correct! The test manager provides evidence and risk; the release authority makes the decision.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Invalidate affected results, document impact, and escalate release risk', s: 'ISO-based action', c: true, p: 210, f: 'Correct! Invalid evidence must be identified, documented, and communicated.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Correct the records, report the manipulation, and restore truthful status', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Test status must reflect real execution evidence.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Evaluate both security fix verification and regression impact, then escalate residual risk', s: 'ISO-based action', c: true, p: 190, f: 'Correct! A fix must be verified while also checking unintended side effects.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Refuse falsification and keep the report evidence-based', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Test reports must accurately reflect evidence, risks, and limitations.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Treat it as high-risk, collect evidence, and escalate uncertainty', s: 'ISO-based action', c: true, p: 210, f: 'Correct! Severity and uncertainty must be communicated with available evidence.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Invalidate previous evidence for final build and require targeted verification', s: 'ISO-based action', c: true, p: 220, f: 'Correct! A different build requires verification before release confidence can be claimed.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Escalate compliance gap with evidence and obtain release authority decision', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Compliance gaps require clear escalation and documented decision-making.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Challenge classification using agreed severity criteria and document rationale', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Classification should be evidence-based and consistent with agreed criteria.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Start incident review, analyze escaped defect, and improve test controls', s: 'ISO-based action', c: true, p: 210, f: 'Correct! The team should analyze why the issue escaped and improve the process.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Record decision owner, rationale, and residual risks', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Accepted risk is not resolved risk; it needs rationale and ownership.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Report rollback test gap and execute priority rollback validation', s: 'ISO-based action', c: true, p: 220, f: 'Correct! Untested rollback creates severe operational risk.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Request evidence, assess confidence, and document limitations', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Vendor results must be supported by evidence and limitations must be visible.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Treat as security incident, revoke secrets, document impact, and fix controls', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Secret exposure requires containment, documentation, and preventive controls.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Provide traceable evidence and identify documented gaps', s: 'ISO-based action', c: true, p: 180, f: 'Correct! Traceability supports auditability and confidence in test results.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Declare incident, secure data, notify responsible parties, and correct data process', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Personal data exposure is a critical incident and requires formal handling.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Report criteria conflict and escalate release decision with residual risk', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Completion decisions must consider all criteria and remaining risks.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Invalidate prior evidence for final build and require targeted verification', s: 'ISO-based action', c: true, p: 230, f: 'Correct! A different build invalidates confidence from previous test evidence.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Review coverage validity and update dashboard with limitations', s: 'ISO-based action', c: true, p: 180, f: 'Correct! Coverage metrics must reflect valid and current test assets.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Create formal test record, capture evidence, and assess residual risk', s: 'ISO-based action', c: true, p: 210, f: 'Correct! Emergency context still requires traceable evidence.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Standardize defect workflow and define verification responsibility', s: 'ISO-based action', c: true, p: 180, f: 'Correct! A clear workflow improves consistency and traceability.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Escalate critical risk with evidence and prevent unsupported release decision', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Rare but severe defects can still block release readiness.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Provide a clear summary while preserving risk and limitation visibility', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Reports can be concise but must not hide known risks.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Assess change impact, define targeted regression, and document residual risk', s: 'ISO-based action', c: true, p: 220, f: 'Correct! Even urgent security fixes need controlled verification.' },
...

    {
        ...
        actions: [
            ...
            { l: 'Document tailoring decision, rationale, risks, and stakeholder agreement', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Tailoring decisions should be justified, recorded, and agreed with stakeholders.' },
    ...
    ,
    {
        ...
        actions: [
            { l: 'Restore residual risks to the report and escalate transparently', s: 'ISO-based action', c: true, p: 220, f: 'Correct! Residual risk visibility is essential for informed release decisions.' },
...

    {
        ...
        actions: [
            { l: 'Investigate instability and classify affected tests as unreliable until fixed', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Flaky automation reduces confidence and must be investigated.' },
...

    {
        ...
        actions: [
            { l: 'Contain exposure, sanitize logs, revoke affected credentials, and document the incident', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Sensitive data exposure requires immediate containment and reporting.' },
...

    {
        ...
        actions: [
            { l: 'Assess integration risk and execute targeted validation tests', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Vendor claims do not replace integration testing evidence.' },
...

    {
        ...
        actions: [
            { l: 'Restore the defect to official reporting and escalate appropriately', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Intentional concealment violates testing ethics and governance.' },
    ...
    ,
    {
        ...
        actions: [
            { l: 'Conduct the completion evaluation and reassess release readiness formally', s: 'ISO-based action', c: true, p: 220, f: 'Correct! Formal completion evaluation ensures evidence, risks, and criteria are reviewed properly.' },
...

    {
        ...
        actions: [
            { l: 'Update traceability links and identify invalidated evidence', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Requirement changes may invalidate old coverage and evidence.' },
...

    {
        ...
        actions: [
            { l: 'Revoke access immediately, investigate exposure, and document the incident', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Unauthorized production access is a critical operational and security incident.' },
...

    {
        ...
        actions: [
            { l: 'Prioritize maintenance and restore automation reliability systematically', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Testware maintenance is essential for sustainable automation.' },
...

    {
        ...
        actions: [
            { l: 'Require evidence-based risk review and document the acceptance decision', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Accepted risks should still be evidence-based and traceable.' },
...

    {
        ...
        actions: [
            { l: 'Centralize and control evidence storage with defined access and retention', s: 'ISO-based action', c: true, p: 180, f: 'Correct! Controlled evidence storage improves auditability and traceability.' },
...

    {
        ...
        actions: [
            { l: 'Interpret pass rate together with scope, coverage, and residual risks', s: 'ISO-based action', c: true, p: 190, f: 'Correct! High pass percentages can still hide serious gaps.' },
...

    {
        ...
        actions: [
            { l: 'Treat the event as an operational incident and assess recovery options immediately', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Evidence and environment corruption require immediate containment and recovery analysis.' },
...

    {
        ...
        actions: [
            { l: 'Restore evidence-based classification and escalate integrity concerns', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Severity should reflect actual impact, not political pressure.' },
...

    {
        ...
        actions: [
            { l: 'Implement controlled emergency procedures with documented approvals and evidence', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Emergency processes still require governance and traceability.' },
    ...
    ,
    {
        ...
        actions: [
            { l: 'Update the sign-off with unresolved incidents and residual risk details', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Residual defects must remain visible for informed release decisions.' },
...

    {
        ...
        actions: [
            { l: 'Correct traceability links and reassess actual coverage', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Traceability should reflect real evidence and valid relationships.' },
...

    {
        ...
        actions: [
            { l: 'Execute targeted integration and environment validation before release', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Security changes require validation in realistic conditions.' },
...

    {
        ...
        actions: [
            { l: 'Correct report logic and distinguish skipped, blocked, failed, and passed tests', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Accurate execution state classification supports reliable reporting.' },
...

    {
        ...
        actions: [
            { l: 'Escalate the missing coverage and assess release impact immediately', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Untested critical workflows create major residual risk.' },
...

    {
        ...
        actions: [
            { l: 'Restore traceable audit information and improve record controls', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Auditability depends on controlled and complete records.' },
...

    {
        ...
        actions: [
            { l: 'Correct reporting to reflect implementation and execution gaps accurately', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Coverage metrics should reflect real implementation and execution evidence.' },
...

    {
        ...
        actions: [
            { l: 'Implement strict configuration identification and execution traceability', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Environment traceability is essential for reproducibility and investigation.' },
...

    {
        ...
        actions: [
            { l: 'Reopen the incident, analyze root cause, and review verification effectiveness', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Reappearing failures require root-cause and verification analysis.' },
...

    {
        ...
        actions: [
            { l: 'Maintain evidence integrity and escalate unethical pressure appropriately', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Testing evidence must remain objective and trustworthy under all conditions.' },
    ...
    ,
    {
        ...
        actions: [
            { l: 'Include failed recovery scenarios and explain residual operational risk', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Executive summaries must still reflect critical unresolved risks.' },
...

    {
        ...
        actions: [
            { l: 'Escalate the missing verification gap and create traceable coverage immediately', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Safety-related requirements require explicit and traceable verification evidence.' },
...

    {
        ...
        actions: [
            { l: 'Document exposure, escalate severity, and reassess release readiness immediately', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Known exploitable vulnerabilities require formal reassessment and escalation.' },
...

    {
        ...
        actions: [
            { l: 'Assess infrastructure differences and add representative validation coverage', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Environment differences can invalidate assumptions about scalability and behavior.' },
...

    {
        ...
        actions: [
            { l: 'Restore omitted risks and escalate governance concerns transparently', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Risk visibility is essential for informed decision-making.' },
...

    {
        ...
        actions: [
            { l: 'Improve evidence retention, traceability, and decision documentation practices', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Release justification should remain reproducible and auditable.' },
...

    {
        ...
        actions: [
            { l: 'Refocus metrics on decision support and underlying quality risks', s: 'ISO-based action', c: true, p: 220, f: 'Correct! Metrics should support quality understanding, not become targets themselves.' },
...

    {
        ...
        actions: [
            { l: 'Treat as a critical operational incident and review environment separation controls', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Test artifacts leaking into production indicate serious control failures.' },
...

    {
        ...
        actions: [
            { l: 'Reopen the incident and require verification evidence before closure', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Closure should depend on verified evidence, not assumptions.' },
...

    {
        ...
        actions: [
            { l: 'Escalate repeated governance failures and redesign the release process realistically', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Repeated bypasses indicate systemic process and planning problems.' },
    ...
    ,
    {
        ...
        actions: [
            { l: 'Restore evidence-based recommendation and document justification changes formally', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Release recommendations should change only with supporting evidence or documented rationale.' },
...

    {
        ...
        actions: [
            { l: 'Clarify measurable acceptance and verification conditions before approval', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Requirements should be testable and objectively verifiable.' },
...

    {
        ...
        actions: [
            { l: 'Treat as a serious integrity incident and restore trustworthy evidence immediately', s: 'ISO-based action', c: true, p: 260, f: 'Correct! Tampering with evidence compromises governance, trust, and auditability.' },
...

    {
        ...
        actions: [
            { l: 'Explain coverage limitations and combine automation with other testing approaches', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Automation is powerful but does not replace all forms of testing.' },
...

    {
        ...
        actions: [
            { l: 'Establish dependency monitoring and targeted regression coverage immediately', s: 'ISO-based action', c: true, p: 240, f: 'Correct! External dependencies require ongoing monitoring and regression assessment.' },
...

    {
        ...
        actions: [
            { l: 'Introduce traceable review approval recording and audit controls', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Review decisions should remain traceable and auditable.' },
...

    {
        ...
        actions: [
            { l: 'Correct metric calculation and report actual execution coverage transparently', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Metrics should support truthful project visibility and decisions.' },
...

    {
        ...
        actions: [
            { l: 'Escalate the operational risk and restore strict environment separation immediately', s: 'ISO-based action', c: true, p: 260, f: 'Correct! Production and testing boundaries should remain strictly controlled.' },
...

    {
        ...
        actions: [
            { l: 'Investigate root cause, reassess classification practices, and improve escalation rules', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Missed escalation signals should trigger process learning and improvement.' },
...

    {
        ...
        actions: [
            { l: 'Refocus testing activities on risk understanding, evidence quality, and decision support', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Testing should support informed quality and risk decisions, not just paperwork completion.' },
    ...
    ,
    {
        ...
        actions: [
            { l: 'Document the rationale, reassess risks, and obtain formal stakeholder approval', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Exit criteria changes must be transparent, justified, and risk-assessed.' },
...

    {
        ...
        actions: [
            { l: 'Improve bidirectional traceability between requirements, tests, and incidents', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Effective traceability supports impact analysis and governance.' },
...

    {
        ...
        actions: [
            { l: 'Treat as a security and privacy incident, contain exposure, and notify responsible parties', s: 'ISO-based action', c: true, p: 260, f: 'Correct! Unauthorized external sharing of sensitive information is a serious incident.' },
...

    {
        ...
        actions: [
            { l: 'Clarify automation scope, limitations, and remaining risks explicitly', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Successful automation runs do not automatically prove full product readiness.' },
...

    {
        ...
        actions: [
            { l: 'Identify assumption risk and perform targeted validation or simulation testing', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Untested assumptions can create severe operational surprises.' },
...

    {
        ...
        actions: [
            { l: 'Document decisions, rationale, actions, and ownership formally', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Decision traceability supports accountability and future analysis.' },
...

    {
        ...
        actions: [
            { l: 'Reevaluate metric effectiveness and include operational quality indicators', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Metrics should reflect real product quality outcomes, not just execution counts.' },
...

    {
        ...
        actions: [
            { l: 'Improve environment isolation, scheduling, and usage control', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Shared uncontrolled environments reduce confidence in execution results.' },
...

    {
        ...
        actions: [
            { l: 'Perform root-cause analysis and review verification effectiveness systematically', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Repeated reopenings indicate deeper process or verification weaknesses.' },
...

    {
        ...
        actions: [
            { l: 'Promote transparent risk communication and strengthen objective reporting culture', s: 'ISO-based action', c: true, p: 260, f: 'Correct! Effective testing requires psychological safety and honest reporting.' },
    ...
    ,
    {
        ...
        actions: [
            { l: 'Regenerate evidence using the current build and reassess release readiness', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Release decisions should rely on evidence matching the actual release candidate.' },
...

    {
        ...
        actions: [
            { l: 'Improve business traceability and perform impact analysis immediately', s: 'ISO-based action', c: true, p: 230, f: 'Correct! Business linkage supports prioritization and release risk understanding.' },
...

    {
        ...
        actions: [
            { l: 'Treat as a governance and security incident, reassess controls, and remove the bypass safely', s: 'ISO-based action', c: true, p: 260, f: 'Correct! Temporary exceptions should be tracked, reviewed, and removed formally.' },
...

    {
        ...
        actions: [
            { l: 'Review and align automation assets with the current test basis', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Automation should remain synchronized with current requirements and risks.' },
...

    {
        ...
        actions: [
            { l: 'Validate operational fallback procedures through realistic scenario testing', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Recovery assumptions should be validated with evidence.' },
...

    {
        ...
        actions: [
            { l: 'Standardize reporting structure, terminology, and evidence expectations', s: 'ISO-based action', c: true, p: 190, f: 'Correct! Standardization improves comparability and governance quality.' },
...

    {
        ...
        actions: [
            { l: 'Refocus governance discussions on actual risk exposure and evidence quality', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Metrics should support decision-making rather than become the goal themselves.' },
...

    {
        ...
        actions: [
            { l: 'Contain exposure, sanitize environments, rotate credentials, and review cloning controls', s: 'ISO-based action', c: true, p: 270, f: 'Correct! Production cloning requires strict sanitization and access controls.' },
...

    {
        ...
        actions: [
            { l: 'Review backlog systematically, reassess risk, and escalate unresolved critical exposure', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Long-unresolved incidents may indicate severe governance weaknesses.' },
...

    {
        ...
        actions: [
            { l: 'Align operational practices with documented governance and assess real conformance honestly', s: 'ISO-based action', c: true, p: 270, f: 'Correct! Claimed compliance should reflect real operational behavior and evidence.' },
    ...
    ,
    {
        ...
        actions: [
            { l: 'Escalate rollback failure risk and reassess deployment readiness formally', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Failed rollback capability creates major operational risk.' },
...

    {
        ...
        actions: [
            { l: 'Establish operational traceability between customer impact, requirements, and testing artifacts', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Operational feedback should connect back to testing and requirements.' },
...

    {
        ...
        actions: [
            { l: 'Treat as a security governance incident and review tool approval controls', s: 'ISO-based action', c: true, p: 260, f: 'Correct! Unauthorized tooling may expose sensitive project and customer information.' },
...

    {
        ...
        actions: [
            { l: 'Allocate planned maintenance effort and monitor automation reliability trends', s: 'ISO-based action', c: true, p: 200, f: 'Correct! Sustainable automation requires continuous maintenance investment.' },
...

    {
        ...
        actions: [
            { l: 'Assign clear ownership, escalation paths, and monitoring responsibilities', s: 'ISO-based action', c: true, p: 240, f: 'Correct! Effective risk management requires clear accountability.' },
...

    {
        ...
        actions: [
            { l: 'Introduce controlled evidence retention and versioning practices', s: 'ISO-based action', c: true, p: 210, f: 'Correct! Historical evidence supports audits, investigations, and learning.' },
...

    {
        ...
        actions: [
            { l: 'Redesign metrics to reward transparency, learning, and risk visibility', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Metrics should encourage truthful reporting and continuous improvement.' },
...

    {
        ...
        actions: [
            { l: 'Restore monitoring immediately and assess the hidden operational exposure', s: 'ISO-based action', c: true, p: 260, f: 'Correct! Monitoring visibility is critical during high-risk deployment windows.' },
...

    {
        ...
        actions: [
            { l: 'Reassess recurring incidents systematically and challenge normalization of risk', s: 'ISO-based action', c: true, p: 250, f: 'Correct! Repeated severe failures should trigger deeper corrective action.' },
...

    {
        ...
        actions: [
            { l: 'Reinforce testing as evidence-based risk evaluation and decision support', s: 'ISO-based action', c: true, p: 270, f: 'Correct! Testing exists to support informed quality and risk decisions.' },
