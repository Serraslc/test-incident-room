const EASY_INCIDENTS = [
  ...
  },
  {
    ...
    actions: [
      { l: 'Classify it as static testing', s: '29119-1: Static testing', c: true, p: 100, f: 'Correct! Static testing evaluates work products without running the software.' },
...

  {
    ...
    actions: [
      { l: 'Classify it as dynamic testing', s: '29119-1: Dynamic testing', c: true, p: 100, f: 'Correct! Dynamic testing involves executing the test item and evaluating the result.' },
...

  {
    ...
    actions: [
      { l: 'Use a test oracle to determine the expected result', s: '29119-1: Test oracle', c: true, p: 100, f: 'Correct! A test oracle is a source used to determine expected outcomes.' },
...

  {
    ...
    actions: [
      { l: 'Use requirements, user stories, or models as the test basis', s: '29119-1: Test basis', c: true, p: 100, f: 'Correct! The test basis provides information used to design and implement tests.' },
...

  {
    ...
    actions: [
      { l: 'Identify the work product or component under test', s: '29119-1: Test item', c: true, p: 100, f: 'Correct! A test item can be a system, component, document, or other work product being tested.' },
...

  {
    ...
    actions: [
      { l: 'Explain that exhaustive testing is usually impractical', s: '29119-1: Exhaustive testing and sampling', c: true, p: 110, f: 'Correct! Testing normally uses selected samples guided by risk, strategy, and coverage goals.' },
...

  {
    ...
    actions: [
      { l: 'Prioritize testing based on risk and impact', s: '29119-1/2: Risk-based testing', c: true, p: 110, f: 'Correct! Risk-based testing focuses effort on areas where failure would matter most.' },
...

  {
    ...
    actions: [
      { l: 'Define the objective of the testing activity', s: '29119-1: Test objective', c: true, p: 110, f: 'Correct! A test objective explains the purpose of testing and guides evaluation.' },
...

  {
    ...
    actions: [
      { l: 'Add expected results and preconditions where needed', s: '29119-3: Test case specification', c: true, p: 110, f: 'Correct! A useful test case must allow the tester to execute and evaluate the result.' },
...

  {
    ...
    actions: [
      { l: 'Use the test execution log to show what was run and observed', s: '29119-3: Test execution log', c: true, p: 110, f: 'Correct! Execution logs record test execution information and observed results.' },
...

  {
    ...
    actions: [
      { l: 'Record it as the actual result', s: '29119-3: Actual results', c: true, p: 110, f: 'Correct! Actual results are what is observed during test execution.' },
...

  {
    ...
    actions: [
      { l: 'Add steps, expected result, actual result, context, severity, and priority', s: '29119-3: Test incident report', c: true, p: 110, f: 'Correct! Incident reports should contain enough information for analysis and prioritization.' },
...

  {
    ...
    actions: [
      { l: 'Prepare or confirm test data before relying on results', s: '29119-3: Test data readiness', c: true, p: 110, f: 'Correct! Test data readiness supports valid and repeatable execution.' },
...

  {
    ...
    actions: [
      { l: 'Confirm environment readiness before trusting results', s: '29119-3: Test environment readiness', c: true, p: 110, f: 'Correct! Environment readiness helps ensure results are valid and repeatable.' },
...

  {
    ...
    actions: [
      { l: 'Test values at and near 1 and 100', s: '29119-4: Boundary value analysis', c: true, p: 100, f: 'Correct! Boundary values often reveal input validation defects.' },
...

  {
    ...
    actions: [
      { l: 'Group similar inputs and test representative values', s: '29119-4: Equivalence partitioning', c: true, p: 100, f: 'Correct! Equivalent inputs can be sampled using representative test cases.' },
...

  {
    ...
    actions: [
      { l: 'Use decision table testing for combinations of conditions', s: '29119-4: Decision table testing', c: true, p: 100, f: 'Correct! Decision tables help test business rules with multiple condition combinations.' },
...

  {
    ...
    actions: [
      { l: 'Use state transition testing for valid and invalid transitions', s: '29119-4: State transition testing', c: true, p: 100, f: 'Correct! State transition testing is useful when behavior depends on states and transitions.' },
...

  {
    ...
    actions: [
      { l: 'Use test monitoring and control to compare progress against the plan', s: '29119-2: Test monitoring and control', c: true, p: 110, f: 'Correct! Monitoring and control tracks progress, deviations, blockers, and risks.' },
...

  {
    ...
    actions: [
      { l: 'Prepare a test completion report', s: '29119-3: Test completion report', c: true, p: 110, f: 'Correct! A completion report summarizes testing performed, deviations, measures, residual risks, and deliverables.' },
...

  {
    ...
    actions: [
      { l: 'Explain pass rate together with coverage and risk context', s: '29119-2/3: Test metrics and reporting', c: true, p: 110, f: 'Correct! Metrics can mislead if they are not interpreted with coverage and risk context.' },
...

  {
    ...
    actions: [
      { l: 'Create or restore traceability from requirement to test case', s: '29119-3: Traceability', c: true, p: 110, f: 'Correct! Traceability helps show whether requirements are covered by tests.' },
...

  {
    ...
    actions: [
      { l: 'Assess whether automation covers the relevant risks and gaps', s: '29119-1: Manual and automated testing', c: true, p: 110, f: 'Correct! Automation is valuable, but coverage and risk still need evaluation.' },
...

  {
    ...
    actions: [
      { l: 'Assess severity by impact and priority by urgency/planning need', s: '29119-3: Incident severity and priority', c: true, p: 110, f: 'Correct! Severity describes impact; priority helps plan when it should be handled.' },
...

  {
    ...
    actions: [
      { l: 'Document the tailoring decision, rationale, and stakeholder agreement', s: '29119 series: Tailored conformance', c: true, p: 110, f: 'Correct! Tailoring is allowed when the level of tailoring and rationale are described and agreed.' },
  ...
  },
  {
    ...
    actions: [
      { l: 'Classify these artifacts as testware', s: '29119-1: Testware', c: true, p: 100, f: 'Correct! Testware includes the work products produced or used during testing.' },
...

  {
    ...
    actions: [
      { l: 'Classify this as confirmation testing (retesting)', s: '29119-1: Confirmation testing', c: true, p: 100, f: 'Correct! Confirmation testing checks whether a specific defect fix works.' },
...

  {
    ...
    actions: [
      { l: 'Check whether entry criteria are satisfied before execution', s: '29119-2: Entry criteria', c: true, p: 110, f: 'Correct! Entry criteria help determine whether testing can begin reliably.' },
...

  {
    ...
    actions: [
      { l: 'Define measurable exit criteria in the test plan', s: '29119-2: Exit criteria', c: true, p: 110, f: 'Correct! Exit criteria can include coverage, defect levels, risk thresholds, and schedule considerations.' },
...

  {
    ...
    actions: [
      { l: 'Prepare a test summary or completion report', s: '29119-3: Test completion reporting', c: true, p: 110, f: 'Correct! Completion reports summarize scope, execution, defects, deviations, and residual risk.' },
...

  {
    ...
    actions: [
      { l: 'Use error guessing as an experience-based technique', s: '29119-4: Error guessing', c: true, p: 100, f: 'Correct! Error guessing uses tester knowledge and experience to target likely problem areas.' },
...

  {
    ...
    actions: [
      { l: 'Use use case testing based on user interactions and flows', s: '29119-4: Use case testing', c: true, p: 100, f: 'Correct! Use case testing derives tests from user scenarios and system interactions.' },
...

  {
    ...
    actions: [
      { l: 'Document and communicate residual risk', s: '29119-2: Residual risk', c: true, p: 110, f: 'Correct! Residual risk refers to risk that remains after testing and mitigation activities.' },
...

  {
    ...
    actions: [
      { l: 'Use defect density as a quality-related metric', s: '29119-2: Test metrics', c: true, p: 110, f: 'Correct! Defect density helps relate defect counts to product size or scope.' },
...

  {
    ...
    actions: [
      { l: 'Link or merge duplicate incident reports carefully', s: '29119-3: Incident management', c: true, p: 110, f: 'Correct! Duplicate incidents should be managed without losing traceability or useful details.' },
...

  {
    ...
    actions: [
      { l: 'Record configuration and version information during execution', s: '29119-3: Configuration information', c: true, p: 110, f: 'Correct! Version identification supports traceability and repeatability.' },
...

  {
    ...
    actions: [
      { l: 'Document the environment and reproduce across supported browsers', s: '29119-2/3: Environment coverage', c: true, p: 110, f: 'Correct! Environment information is essential for reproducibility and compatibility testing.' },
...

  {
    ...
    actions: [
      { l: 'Maintain and update affected automated tests', s: '29119-1: Test maintenance', c: true, p: 110, f: 'Correct! Automated tests require maintenance as systems evolve.' },
...

  {
    ...
    actions: [
      { l: 'Use traceability and coverage information to answer', s: '29119-3: Traceability', c: true, p: 110, f: 'Correct! Traceability helps connect requirements, tests, execution, and defects.' },
...

  {
    ...
    actions: [
      { l: 'Reprioritize and adjust testing through test control activities', s: '29119-2: Test control', c: true, p: 110, f: 'Correct! Test control involves taking corrective action based on monitoring information.' },
...

  {
    ...
    actions: [
      { l: 'Use checklist-based testing to guide evaluation', s: '29119-4: Checklist-based testing', c: true, p: 100, f: 'Correct! Checklists help ensure important concerns are considered consistently.' },
...

  {
    ...
    actions: [
      { l: 'Consider both likelihood and impact when evaluating risk', s: '29119-2: Risk evaluation', c: true, p: 110, f: 'Correct! Risk is influenced by both probability and consequence.' },
...

  {
    ...
    actions: [
      { l: 'Require verification before closure when appropriate', s: '29119-3: Incident lifecycle', c: true, p: 110, f: 'Correct! Verification supports reliable closure decisions.' },
...

  {
    ...
    actions: [
      { l: 'Document untested scope and associated risk', s: '29119-2/3: Completion reporting', c: true, p: 110, f: 'Correct! Untested scope should remain visible to stakeholders.' },
...

  {
    ...
    actions: [
      { l: 'Replace vague expectations with measurable expected results', s: '29119-3: Expected results', c: true, p: 110, f: 'Correct! Expected results should be specific enough to support pass/fail evaluation.' },
...

  {
    ...
    actions: [
      { l: 'Provide updated evidence, risks, and rationale transparently', s: '29119-2: Communication and reporting', c: true, p: 110, f: 'Correct! Recommendations should be evidence-based and traceable.' },
...

  {
    ...
    actions: [
      { l: 'Improve test isolation and reset shared state where needed', s: '29119-1/2: Controlled test environment', c: true, p: 110, f: 'Correct! Poor isolation can reduce repeatability and reliability.' },
...

  {
    ...
    actions: [
      { l: 'Use metrics that support decisions and explain their context', s: '29119-2: Test metrics interpretation', c: true, p: 110, f: 'Correct! Metrics should support understanding and decision-making.' },
...

  {
    ...
    actions: [
      { l: 'Investigate and correct the automated test or environment issue', s: '29119-1: Automation reliability', c: true, p: 110, f: 'Correct! Automated tests themselves can fail incorrectly and require maintenance.' },
...

  {
    ...
    actions: [
      { l: 'Explain that testing reduces risk but cannot guarantee defect-free software', s: '29119-1: Limits of testing', c: true, p: 100, f: 'Correct! Testing provides information and reduces uncertainty, but cannot prove the absence of all defects.' },
  ...
  ,
  {
    ...
    actions: [
      { l: 'Explain that independent testing can reduce bias', s: '29119-1: Test independence', c: true, p: 100, f: 'Correct! Independent testing can provide a different perspective and reduce confirmation bias.' },
...

  {
    ...
    actions: [
      { l: 'Classify it as scripted testing', s: '29119-1: Scripted testing', c: true, p: 100, f: 'Correct! Scripted testing follows predefined test cases or procedures.' },
...

  {
    ...
    actions: [
      { l: 'Classify it as exploratory testing', s: '29119-1: Exploratory testing', c: true, p: 100, f: 'Correct! Exploratory testing combines learning, test design, and execution.' },
...

  {
    ...
    actions: [
      { l: 'Use the model as a basis for identifying coverage items and deriving tests', s: '29119-3/4: Test model', c: true, p: 110, f: 'Correct! Test models represent testable aspects and can guide coverage and test case derivation.' },
...

  {
    ...
    actions: [
      { l: 'Use scenario testing based on realistic interaction sequences', s: '29119-4: Scenario testing', c: true, p: 100, f: 'Correct! Scenario testing exercises sequences of interactions between the user and the system.' },
...

  {
    ...
    actions: [
      { l: 'Use random testing with a defined purpose and evaluation method', s: '29119-4: Random testing', c: true, p: 100, f: 'Correct! Random testing can be useful when generation and evaluation are controlled.' },
...

  {
    ...
    actions: [
      { l: 'Assign unique identifiers to test documentation items', s: '29119-3: Common information elements', c: true, p: 110, f: 'Correct! Unique identifiers improve traceability and prevent confusion across test artifacts.' },
...

  {
    ...
    actions: [
      { l: 'Maintain change history and approval information', s: '29119-3: Common information elements', c: true, p: 110, f: 'Correct! Change history and approval authority help control test documentation.' },
...

  {
    ...
    actions: [
      { l: 'Add the reporting period to the status report', s: '29119-3: Test status report', c: true, p: 110, f: 'Correct! The reporting period helps stakeholders interpret progress and measures correctly.' },
...

  {
    ...
    actions: [
      { l: 'List relevant test deliverables in the completion report', s: '29119-3: Test completion report', c: true, p: 110, f: 'Correct! Test deliverables help stakeholders understand what evidence and assets were produced.' },
...

  {
    ...
    actions: [
      { l: 'Classify this as requirements-based testing', s: '29119-4: Requirements-based testing', c: true, p: 100, f: 'Correct! Requirements-based testing derives tests from requirements and checks their implementation.' },
...

  {
    ...
    actions: [
      { l: 'Use the classification tree method', s: '29119-4: Classification tree method', c: true, p: 100, f: 'Correct! This method models input classifications and classes to design systematic test cases.' },
...

  {
    ...
    actions: [
      { l: 'Use combinatorial testing to cover selected parameter-value combinations', s: '29119-4: Combinatorial testing', c: true, p: 100, f: 'Correct! Combinatorial techniques help test interactions among parameter-value pairs efficiently.' },
...

  {
    ...
    actions: [
      { l: 'Define a test strategy covering approach, risks, levels, types, and techniques', s: '29119-1/2: Test strategy', c: true, p: 110, f: 'Correct! A test strategy describes the testing approach and guides detailed planning.' },
...

  {
    ...
    actions: [
      { l: 'Treat them as different test levels with different objectives', s: '29119-1: Test levels', c: true, p: 110, f: 'Correct! Test levels organize testing stages with specific objectives.' },
...

  {
    ...
    actions: [
      { l: 'Recognize these as different test types targeting quality characteristics', s: '29119-1: Test types', c: true, p: 110, f: 'Correct! Test types focus testing on particular objectives or quality characteristics.' },
...

  {
    ...
    actions: [
      { l: 'Use focused testing as a risk treatment activity', s: '29119-1/2: Testing as risk treatment', c: true, p: 110, f: 'Correct! Testing is a primary way to gather evidence and reduce uncertainty around risk.' },
...

  {
    ...
    actions: [
      { l: 'Document assumptions and constraints in the test plan', s: '29119-3: Test plan', c: true, p: 110, f: 'Correct! Assumptions and constraints help stakeholders understand planning dependencies.' },
...

  {
    ...
    actions: [
      { l: 'Identify stakeholders and communication needs in the test plan', s: '29119-3: Test plan stakeholders', c: true, p: 110, f: 'Correct! Stakeholder identification supports proper communication and reporting.' },
...

  {
    ...
    actions: [
      { l: 'Use the planned testing communication path', s: '29119-3: Testing communication', c: true, p: 110, f: 'Correct! Test planning should define how testing information is communicated.' },
...

  {
    ...
    actions: [
      { l: 'Perform test design and implementation activities', s: '29119-2/4: Test design and implementation', c: true, p: 110, f: 'Correct! Test design uses models and coverage items to derive test cases and procedures.' },
...

  {
    ...
    actions: [
      { l: 'Record the result and consider raising an incident', s: '29119-2/3: Test execution and incident reporting', c: true, p: 110, f: 'Correct! Differences between expected and actual results should be recorded and analyzed.' },
...

  {
    ...
    actions: [
      { l: 'Include security-focused testing in the test strategy', s: '29119-1: Test types and quality characteristics', c: true, p: 110, f: 'Correct! Security-related risks should influence test types and strategy.' },
...

  {
    ...
    actions: [
      { l: 'Use 29119-2 for process, 29119-3 for documentation, and 29119-4 for techniques', s: '29119 series integration', c: true, p: 110, f: 'Correct! The standards complement each other: process, documentation, and techniques work together.' },
...

  {
    ...
    actions: [
      { l: 'Keep 29119-2 as the core and use 29119-1/3/4 as supporting context', s: '29119 series integration', c: true, p: 110, f: 'Correct! The strongest academic design keeps Test Processes central while connecting concepts, documentation, and techniques.' },
