const MEDIUM_INCIDENTS = [
  {
    ...
    actions: [
      ...
      { l: 'Create, agree, and communicate the Test Plan before continuing', s: 'ISO-based action', c: true, p: 130, f: 'Correct! The Test Plan should define scope, approach, resources, schedule, and responsibilities.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Clarify the test basis with stakeholders before designing tests', s: 'ISO-based action', c: true, p: 130, f: 'Correct! The test basis must be understood before reliable test cases can be designed.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Document the incident, classify severity, and escalate immediately', s: 'ISO-based action', c: true, p: 150, f: 'Correct! Critical incidents require timely reporting, classification, and communication to stakeholders.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Align the environment or document limitations and risk', s: 'ISO-based action', c: true, p: 140, f: 'Correct! The environment must support valid testing, and limitations must be visible.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Report coverage, remaining tests, and release risk', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Progress, gaps, and risks must be communicated for informed decisions.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Define incident reporting rules and update weak reports', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Incident reports should include enough information for analysis and reproduction.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Clarify expected behavior and update the test basis if needed', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Testing requires a clear expected result based on a valid test basis.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Document test status, risks, and escalate the decision', s: 'ISO-based action', c: true, p: 150, f: 'Correct! The test manager reports evidence and risk; release authority decides.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Open an infrastructure incident and assess manual fallback', s: 'ISO-based action', c: true, p: 130, f: 'Correct! Infrastructure problems should be recorded, coordinated, and assessed for impact.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Update the Test Plan with changed scope, risks, and schedule', s: 'ISO-based action', c: true, p: 130, f: 'Correct! The Test Plan should be maintained when scope or risk changes.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Merge duplicates and keep one traceable main record', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Duplicates should be consolidated without losing useful information.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Reprioritize remaining testing based on product risk', s: 'ISO-based action', c: true, p: 140, f: 'Correct! High-risk areas should receive priority.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Collect evidence or re-execute affected tests', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Passed results should be supported by execution evidence.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Assess impact and update affected test cases', s: 'ISO-based action', c: true, p: 130, f: 'Correct! Test cases must stay aligned with the current test basis.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Investigate instability and mark the test as unreliable until fixed', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Flaky tests reduce trust in results and must be investigated.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Add untested scope, limitations, and residual risks', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Test completion reporting must communicate remaining risk.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Use agreed severity criteria and document rationale', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Severity should be based on defined criteria and evidence.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Document the coverage gap and execute priority Safari tests', s: 'ISO-based action', c: true, p: 130, f: 'Correct! Test coverage should reflect realistic user environments.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Stop unsafe use, document issue, and replace with controlled test data', s: 'ISO-based action', c: true, p: 130, f: 'Correct! Test data must be controlled, especially when privacy risks exist.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Report pass rate together with coverage gaps and risk', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Metrics must be interpreted with coverage and risk context.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Define and enforce workflow with verification before closure', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Defect closure should be controlled and verified.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Assess impact, update tests, and identify invalidated evidence', s: 'ISO-based action', c: true, p: 150, f: 'Correct! A changed test basis can invalidate previous test evidence.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Log the incident and consider adding coverage for that scenario', s: 'ISO-based action', c: true, p: 110, f: 'Correct! Unexpected findings should be recorded and can improve future coverage.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Prepare consolidated evidence: coverage, defects, risks, limitations', s: 'ISO-based action', c: true, p: 150, f: 'Correct! Release readiness requires consolidated and understandable test evidence.' },
...

  {
    ...
    actions: [
      ...
      { l: 'Update report with device, browser, environment, and reproduction details', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Environment details are essential for reproduction and analysis.' },
  ...
  ,
  {
    ...
    actions: [
      { l: 'Add a risk register and use it to prioritize testing', s: 'ISO-based action', c: true, p: 140, f: 'Correct! A risk register helps connect testing priorities to product and project risks.' },
...

  {
    ...
    actions: [
      { l: 'Add blockers, progress against plan, and changed risks', s: 'ISO-based action', c: true, p: 120, f: 'Correct! A useful status report includes progress, blockers, measures, planned testing, and risk changes.' },
...

  {
    ...
    actions: [
      { l: 'Confirm environment and data readiness before trusting results', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Environment readiness evidence helps ensure that test results are valid and repeatable.' },
...

  {
    ...
    actions: [
      { l: 'Add priority information to support planning and resolution order', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Severity describes impact; priority supports planning and scheduling.' },
...

  {
    ...
    actions: [
      { l: 'Archive and reuse stable test assets where appropriate', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Reusable test assets improve consistency, efficiency, and maintainability.' },
...

  {
    ...
    actions: [
      { l: 'Document assumptions and constraints in the test plan', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Assumptions and constraints help stakeholders understand dependencies and planning risk.' },
...

  {
    ...
    actions: [
      { l: 'Identify stakeholders and communication needs in the test plan', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Stakeholder identification supports clear reporting and decision-making.' },
...

  {
    ...
    actions: [
      { l: 'Record actual result and supporting evidence', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Actual results make test execution auditable and support the test result.' },
...

  {
    ...
    actions: [
      { l: 'Restore traceability from requirement to test case and result', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Traceability shows whether requirements are covered and supported by evidence.' },
...

  {
    ...
    actions: [
      { l: 'Add deviations, residual risks, measures, and completion evaluation', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Completion reports should summarize testing performed, deviations, measures, deliverables, and residual risks.' },
...

  {
    ...
    actions: [
      { l: 'Update the status report with the changed risk and planned response', s: 'ISO-based action', c: true, p: 140, f: 'Correct! New and changed risks should be communicated during monitoring and reporting.' },
...

  {
    ...
    actions: [
      { l: 'Run impact-based regression tests after confirming the fix', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Retesting confirms the fix, while regression testing checks unintended side effects.' },
...

  {
    ...
    actions: [
      { l: 'Investigate flakiness and separate product, environment, and testware causes', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Flaky tests reduce confidence and must be analyzed before using results for decisions.' },
...

  {
    ...
    actions: [
      { l: 'Report pass rate together with coverage gaps and risk context', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Metrics must be interpreted with coverage and risk context.' },
...

  {
    ...
    actions: [
      { l: 'Use agreed severity criteria and document rationale', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Severity should be based on defined criteria and evidence, not personal preference.' },
...

  {
    ...
    actions: [
      { l: 'Reprioritize remaining tests based on product risk', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Risk-based testing focuses effort where failure impact is highest.' },
...

  {
    ...
    actions: [
      { l: 'Update the procedure with startup, order, and wrap-up information', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Test procedures should support repeatable execution by describing order and required setup.' },
...

  {
    ...
    actions: [
      { l: 'Define test data reset and isolation needs', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Test data requirements should include resetting needs to support repeatable execution.' },
...

  {
    ...
    actions: [
      { l: 'Reconcile the data sources and publish one traceable status', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Stakeholders need consistent and traceable status information.' },
...

  {
    ...
    actions: [
      { l: 'Assess impact, update tests, and identify invalidated evidence', s: 'ISO-based action', c: true, p: 140, f: 'Correct! A changed test basis can invalidate previous test evidence.' },
...

  {
    ...
    desc: "A tester copied real customer data into a shared test environment.",
    actions: [
      { l: 'Stop unsafe use, document the issue, and replace with controlled test data', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Test data must be controlled, especially when privacy risk exists.' },
...

  {
    ...
    actions: [
      { l: 'Prepare consolidated evidence: coverage, defects, risks, and limitations', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Release readiness needs consolidated and understandable evidence.' },
...

  {
    ...
    actions: [
      { l: 'Log the incident and consider adding coverage for that scenario', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Valid defects matter even when found outside scripted tests.' },
...

  {
    ...
    actions: [
      { l: 'Record approval authority and change history', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Approval authority and change history help control important test documentation.' },
...

  {
    ...
    actions: [
      { l: 'Document tailoring decision, rationale, risks, and stakeholder agreement', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Tailoring is acceptable when its scope, rationale, and agreement are documented.' },
  ...
  ,
  {
    ...
    actions: [
      { l: 'Define measurable entry criteria before continuing execution', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Entry criteria help ensure testing starts under controlled conditions.' },
...

  {
    ...
    actions: [
      { l: 'Re-execute tests after ensuring preconditions are satisfied', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Preconditions support repeatable and valid execution.' },
...

  {
    ...
    actions: [
      { l: 'Restore traceability links between requirement, test, and defect', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Traceability supports impact analysis and coverage visibility.' },
...

  {
    ...
    actions: [
      { l: 'Investigate metric sources and reconcile inconsistencies', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Metrics should be consistent, explainable, and traceable.' },
...

  {
    ...
    actions: [
      { l: 'Reopen the incident and update evidence and status', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Defect status should reflect verified evidence.' },
...

  {
    ...
    actions: [
      { l: 'Coordinate environment usage and document impact on execution', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Shared environments require coordination and change control.' },
...

  {
    ...
    actions: [
      { l: 'Evaluate all exit criteria together and escalate remaining risk', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Completion decisions should consider all defined criteria and remaining risks.' },
...

  {
    ...
    actions: [
      { l: 'Review and restrict access according to testing needs', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Access should follow least-privilege principles and controlled testing needs.' },
...

  {
    ...
    actions: [
      { l: 'Update procedures to match the current system behavior', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Procedures should remain aligned with the current test basis and system.' },
...

  {
    ...
    actions: [
      { l: 'Reassess estimation using realistic execution effort and constraints', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Unrealistic estimation creates schedule and quality risks.' },
...

  {
    ...
    actions: [
      { l: 'Create one controlled and consistent reporting source', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Consistent reporting improves trust and decision-making.' },
...

  {
    ...
    actions: [
      { l: 'Retain logs and evidence for diagnosis and auditability', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Logs help analyze failures and support repeatable investigation.' },
...

  {
    ...
    actions: [
      { l: 'Reassess project and product risks based on the new dependency', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Significant changes should trigger updated risk analysis.' },
...

  {
    ...
    actions: [
      { l: 'Introduce controlled versioning and approval tracking', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Version control supports consistency and traceability.' },
...

  {
    ...
    actions: [
      { l: 'Monitor aging trends and escalate unresolved critical incidents', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Long-open critical incidents require visibility and escalation.' },
...

  {
    ...
    actions: [
      { l: 'Capture lessons learned and improvement opportunities', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Retrospective learning supports future process improvement.' },
...

  {
    ...
    actions: [
      { l: 'Record interruptions and evaluate impact on execution results', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Interruptions may affect validity, timing, and repeatability of results.' },
...

  {
    ...
    actions: [
      { l: 'Rewrite expected results to be measurable and observable', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Expected results should support objective evaluation.' },
...

  {
    ...
    actions: [
      { l: 'Update the plan with external dependencies and related risks', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Dependencies affect scheduling, risk, and execution readiness.' },
...

  {
    ...
    actions: [
      { l: 'Document tailoring rationale, scope, and approval', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Tailoring should be controlled, justified, and agreed.' },
  ...
  ,
  {
    ...
    actions: [
      { l: 'Document test data requirements including responsibility, reset, and archiving needs', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Test data requirements should describe needed data, responsibilities, reset needs, and disposal or archiving expectations.' },
...

  {
    ...
    actions: [
      { l: 'Define environment responsibilities and escalation path', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Environment requirements should include responsibility so blockers can be handled quickly.' },
...

  {
    ...
    actions: [
      { l: 'Reconcile incident status and maintain one controlled source of truth', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Incident status should be consistent and traceable to avoid bad planning decisions.' },
...

  {
    ...
    actions: [
      { l: 'Explain that execution percentage must be interpreted with risk, scope, and defect status', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Metrics need context. Execution percentage alone does not equal risk reduction.' },
...

  {
    ...
    actions: [
      { l: 'Review and update the regression suite based on current risk and test basis', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Regression assets must stay aligned with the current product and risk profile.' },
...

  {
    ...
    actions: [
      { l: 'Update the strategy to include relevant test types based on risk', s: 'ISO-based action', c: true, p: 140, f: 'Correct! The test strategy should reflect product risks, including non-functional quality characteristics.' },
...

  {
    ...
    actions: [
      { l: 'Record the decision owner, rationale, and residual risk', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Accepted risk is still risk and should be traceable with ownership and rationale.' },
...

  {
    ...
    actions: [
      { l: 'Keep the failed result until new evidence supports a change', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Test result changes should be based on evidence, not pressure or discussion alone.' },
...

  {
    ...
    actions: [
      { l: 'Complete test design activities before relying on execution results', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Test design identifies models, coverage items, and test cases so execution has a clear basis.' },
...

  {
    ...
    actions: [
      { l: 'Add or reference a glossary for shared testing terminology', s: 'ISO-based action', c: true, p: 120, f: 'Correct! A glossary helps teams interpret documentation consistently.' },
...

  {
    ...
    actions: [
      { l: 'Update the incident with risk and impact assessment', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Incident reports should support prioritization by describing risk and impact.' },
...

  {
    ...
    actions: [
      { l: 'Specify the period needed for the test environment', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Environment requirements should include when the environment is needed.' },
...

  {
    ...
    actions: [
      { l: 'Record the originator and timing information', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Originator and timing information help investigation and follow-up.' },
...

  {
    ...
    actions: [
      { l: 'Add meaningful checks based on expected results or a test oracle', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Automation should evaluate behavior, not just perform actions.' },
...

  {
    ...
    actions: [
      { l: 'Report the trend and reassess release risk', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Defect trends can show increasing risk and should inform decisions.' },
...

  {
    ...
    actions: [
      { l: 'Add staffing and responsibilities to the test plan', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Staffing information clarifies responsibilities and supports realistic planning.' },
...

  {
    ...
    actions: [
      { l: 'Identify reusable test assets during completion activities', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Reusable assets can improve future test efficiency and consistency.' },
...

  {
    ...
    actions: [
      { l: 'Escalate the blocker through the planned communication channel', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Critical blockers should be visible through planned reporting and escalation paths.' },
...

  {
    ...
    actions: [
      { l: 'Record the repeated issue and propose test process improvement', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Recurring testing problems should feed process improvement activities.' },
...

  {
    ...
    actions: [
      { l: 'Update traceability and mark old evidence as superseded or invalidated', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Traceability must reflect current requirements and valid evidence.' },
...

  {
    ...
    actions: [
      { l: 'Assign risk owner and planned response action', s: 'ISO-based action', c: true, p: 140, f: 'Correct! A risk register should support action, not just list concerns.' },
...

  {
    ...
    actions: [
      { l: 'Sanitize sensitive evidence and improve logging controls', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Test evidence should preserve useful information without exposing sensitive data.' },
...

  {
    ...
    actions: [
      { l: 'Clarify expected results and pass/fail criteria', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Clear expected results improve consistency of test evaluation.' },
...

  {
    ...
    actions: [
      { l: 'Correct the coverage claim and add meaningful assertions', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Automation must verify expected behavior to support coverage claims.' },
...

  {
    ...
    actions: [
      { l: 'Provide controlled test documentation and explain any tailored gaps', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Documentation supports auditability, and tailoring should be explained.' },
  ...
  ,
  {
    ...
    actions: [
      { l: 'Reassess scope, risk, priorities, and communicate the impact', s: 'ISO-based action', c: true, p: 140, f: 'Correct! A compressed schedule requires risk-based replanning and transparent communication.' },
...

  {
    ...
    actions: [
      { l: 'Mark tests as blocked, document cause, and report impact', s: 'ISO-based action', c: true, p: 120, f: 'Correct! Blocked tests are not passed or failed; their cause and impact should be communicated.' },
...

  {
    ...
    actions: [
      { l: 'Update the incident with impact, affected scope, and rationale', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Impact and rationale help stakeholders understand severity and priority.' },
...

  {
    ...
    actions: [
      { l: 'Add a clear completion evaluation with residual risks and recommendation', s: 'ISO-based action', c: true, p: 140, f: 'Correct! Completion reporting should help stakeholders understand readiness, remaining risks, and evidence.' },
...

  {
    ...
    actions: [
      { l: 'Keep process decisions central and use documentation/techniques as support', s: 'ISO-based action', c: true, p: 140, f: 'Correct! The strongest design keeps ISO 29119-2 Test Processes as the main learning objective while connecting related standards.' },
